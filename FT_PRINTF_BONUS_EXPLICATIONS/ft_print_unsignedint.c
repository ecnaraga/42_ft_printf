...
/*   Updated: 2023/06/18 12:02:46 by garance          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* *****************************************************************************
 * 
 * Description : Putnbr en recursive qui renvoie le nombre de char print, pour
 * 				 un unsigned int
 *				 
 ...
 * 				 les flags et qui print l'u int, renvoie le nb de char ecrit
 *				 
 * Allocation dynamique : non
 *
